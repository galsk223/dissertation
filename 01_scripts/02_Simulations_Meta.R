rm(list = ls())
source("westcoast-networks/scripts/02_Simulation/0_Port_Regions/01_Choices_Function_MetaExpansion.R")
library(furrr)
# library(foreach)
# library(doParallel)
library(parallel)
...
# t <- read_rds("~/westcoast-networks/data/Simulation/DynamicSimulationOutcomes/MLSizeCacheMeta1_4/Meta_99.rds")
# t2 <- read_rds("~/westcoast-networks/data/Simulation/DynamicSimulationOutcomes/MLSizeCacheMeta1_6/Meta_1.rds")
